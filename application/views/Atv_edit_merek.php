...
<div class="container mt-5">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <!-- Form Action Updated -->
            <form action="<?php echo base_url('Atvmerek/update/' . $atv_merek['id_merek']); ?>" method="POST">
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <!-- Make sure the value is coming from $atv_merek array -->
                        <input type="text" name="nama_merek" id="nama_merek" class="form-control" 
                               value="<?php echo $atv_merek['nama_merek']; ?>" required placeholder="Masukkan nama_merek" />
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <!-- Same here for Keterangan -->
                        <textarea name="Keterangan" id="Keterangan" class="form-control" rows="3" required 
                                  placeholder="Masukkan Keterangan"><?php echo $atv_merek['keterangan']; ?></textarea>
                    </div>
                </div>
                <div class="d-flex justify-content-end">
                    ...
                    <a href="<?php echo base_url('atvmerek'); ?>" class="btn btn-danger">
